...
(function() {
  $(function() {
    return $("#help").on("ajax:success", function(e, data, status, xhr) {
...
// $(document).on("change", "select#studytype_id", function(e){
//   $.ajax({
//       method: "GET",
//       url: "/moderator/assoziations/new",
//       dataType: "json",
//       data: { id: $(this).val() },
...
var obj = { id: 1, name: "adolf" }

$(document).on("change", "select#studytype_id", function(){
$.ajax({
  method: "GET",
  url: "/moderator/assoziations/new",
   data: obj,
